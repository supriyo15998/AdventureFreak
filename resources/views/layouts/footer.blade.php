            ...
            <div class="row align-items-baseline justify-content-between">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-footer-widget mb-80">
                        <!-- Footer Logo -->
                        <a href="{{ route('index') }}" class="footer-logo"><img src="{{asset('img/core-img/logo2newnew.png')}}" alt=""></a>

                        <h4>(+91) 79803 28015</h4>
                        <span>adventurefreakindia@gmail.com</span>
                        <span>CR Road Kamarpara Natagarh Sodepur Dist: 24 North Pgs<br>Kolkata-700113</span>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-4 col-lg-2">
                    <div class="single-footer-widget mb-80">
                        ...
                        <ul class="footer-nav">
                            ...
                            <li><a href="{{ route('adventurous_tour') }}"><i class="fa fa-caret-right" aria-hidden="true"></i> Packages</a></li>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
                    ...
                    <div class="copywrite-text">
                        <p>Developed with ❤ By: &copy; <a style="text-decoration: none;" href="https://thebuglabs.com" target="_blank">The BugLabs</a></p>
                    </div>
                </div>
